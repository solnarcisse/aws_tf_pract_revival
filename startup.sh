user_data = base64encode(<<-EOF
  ...
  # Detect pkg manager (Amazon Linux 2 uses yum; AL2023 uses dnf)
  ...
  md() { curl -sS -H "X-aws-ec2-metadata-token: $TOKEN" "http://169.254.169.254/latest/meta-data/$1" || true; }

  PUBLIC_IP="$(md public-ipv4)"
  PRIVATE_IP="$(md local-ipv4)"
  # Choose an origin for YouTube embeds (prefer public; fall back to private; finally localhost)
  if [ -n "${PUBLIC_IP}" ]; then
  ...
  # --- Write styles.css (separate file) ---
  ...
  *{ box-sizing:border-box; margin:0; padding:0; }
  ...
  /* Video frame with cinematic drop shadow */
  .video-container{
    position: relative;
    width: 100%;
    aspect-ratio: 16 / 9;
  ...
  # --- Write index.html (references styles.css and uses $ORIGIN) ---
  ...
  <body>
    <!-- Soft galaxy backdrop (image + gradients + stars) -->
    ...
    <main class="fight-list">
      ...
      <section class="fight-card">
        ...
        <div class="video-container">
          <iframe
            src="https://www.youtube-nocookie.com/embed/un4O_bv8510?rel=0&modestbranding=1&origin=${ORIGIN}"
            title="Wing Zero vs Epyon — Gundam Wing"
            loading="lazy"
      ...
      <section class="fight-card">
        ...
        <div class="video-container">
          <iframe
            src="https://www.youtube-nocookie.com/embed/qi2rByJed-E?rel=0&modestbranding=1&origin=${ORIGIN}"
      ...
      <section class="fight-card">
        ...
        <div class="video-container">
          <iframe
            src="https://www.youtube-nocookie.com/embed/ZJeZXJ4WsxQ?rel=0&modestbranding=1&origin=${ORIGIN}"
            title="Ultra Instinct Goku vs Jiren"
            loading="lazy"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin"
            allowfullscreen></iframe>
      ...
      <section class="fight-card">
        ...
        <div class="video-container">
          <iframe
            src="https://www.youtube-nocookie.com/embed/MhROyD9HbLE?rel=0&modestbranding=1&origin=${ORIGIN}"
            title="Boogie Woogie — Itadori & Todo vs Hanami"
            loading="lazy"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin"
            allowfullscreen></iframe>
      ...
      <section class="fight-card">
        ...
        <div class="video-container">
          <iframe
            src="https://www.youtube-nocookie.com/embed/prWR7FXMUDM?rel=0&modestbranding=1&origin=${ORIGIN}"
            title="Gon vs Neferpitou"
            loading="lazy"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"
            referrerpolicy="strict-origin-when-cross-origin"
            allowfullscreen></iframe>
      ...
      <section class="fight-card">
        ...
        <div class="video-container">
          <iframe
            src="https://www.youtube-nocookie.com/embed/CDW2ReQZOQU?rel=0&modestbranding=1&origin=${ORIGIN}"
